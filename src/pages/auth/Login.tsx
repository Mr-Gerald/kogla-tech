...
export default function Login() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      setErrorMsg('Google Sign-In is completing cloud verification. Please sign in below using your email and password.');
      setGoogleLoading(false);
    }
  };
    ...
    <div className="pt-32 px-6 pb-20 max-w-md mx-auto text-gray-100 font-sans">
      ...
      >
        ...
        <button
          ...
          className="w-full mb-6 py-3 px-4 bg-zinc-900 hover:bg-zinc-850 border border-zinc-800 hover:border-gold-500/40 text-white font-medium text-xs rounded transition-all flex items-center justify-center gap-3 shadow cursor-pointer"
        >
          {googleLoading ? (
