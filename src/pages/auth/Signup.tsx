...
export default function Signup() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      setErrorMsg('Google Sign-In is completing cloud verification. Please register below with your name, email, and password.');
      setGoogleLoading(false);
    }
  };
    ...
    <div className="pt-28 px-4 sm:px-6 pb-20 max-w-xl mx-auto text-gray-100 font-sans">
      ...
      >
        ...
        <button
          ...
          className="w-full mb-5 py-3 px-4 bg-zinc-900 hover:bg-zinc-850 border border-zinc-800 hover:border-gold-500/40 text-white font-medium text-xs rounded transition-all flex items-center justify-center gap-3 shadow cursor-pointer"
        >
          {googleLoading ? (
